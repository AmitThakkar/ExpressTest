...
exports.generateController = function (schemas) {
    var fs = require("fs");
    ...
    var generateControllers = function () {
        schemas.forEach(function (schemaName) {
            ...
            fs.readFile(__dirname + "/" + "Content.txt", function (error, data) {
                ...
                fs.writeFile(controllersDirectory + domainName + "Controller.js", controller, function (error) {
                    if (error) {
    ...
    fs.exists(controllersDirectory, function (exists) {
        if (exists) {
            ...
            fs.mkdir(controllersDirectory, function (error) {
                if (error) {
